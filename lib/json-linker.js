...
JsonLinker.prototype.toJson = function () {
  ...
  json[this._rootAttr] = [ JsonLinker.links.apply(this, linkingArgs) ]

  if (linksNameFields.length > 1) {
...
JsonLinker.prototype.toEmbeddedModel = function () {
  if (!this._model.hasOwnProperty(this._rootAttr))
    throw new Error('Root attribute not supported')

  return JsonLinker.unlinks(this._model[this._rootAttr][0], this._model.linked)
}
